      ...
      <AppBar className="grid place-content-center sticky top-0  !bg-[#FFFFFF] !text-slate-800 !shadow-sm" >
        <Toolbar>
          ...
          <Box sx={{ display: { xs: 'none', md: 'flex' } }} className="pr-4">
            ...
            <MenuItem onClick={()=> changeSectionHandler("Anasayfa")}>Anasayfa</MenuItem>
           <MenuItem onClick={()=> changeSectionHandler("Yazılar")}>Yazılar</MenuItem>
           <MenuItem onClick={()=> changeSectionHandler("Şiirler")}>Şiirler</MenuItem>
           <MenuItem onClick={()=> changeSectionHandler("Makaleler")}>Makaleler</MenuItem>
           <MenuItem onClick={()=> changeSectionHandler("Hakkımda")}>Hakkımda</MenuItem>
            </MenuList>
