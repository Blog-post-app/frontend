...
const SinglePost = () => {
  ...
  const decodedHTML = new DOMParser().parseFromString(content, "text/html").body
    .textContent;
  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center place-items-center h-auto pt-12 w-full px-[20%] pb-12">
        <h1 className="title font-bold text-4xl pb-8 h-auto tracking-wider leading-relaxed	subpixel-antialiased">
          {title}
        </h1>
        <img src={image} className="h-auto shadow-lg"></img>

        <div className="flex flex-row w-full pt-8 pb-6">
          <div className="w-[60px] h-[60px] rounded-full bg-sky-100 text-center pt-3 text-2xl font-bold">
            A
          </div>
          <div className="flex flex-col pl-6">
            <h3 className="text-2xl font-semibold">Ali Çendek</h3>
        ...
        <div className=" border-t-2 border-slate-200 w-full h-auto pt-6">
          <p
            className="text-md tracking-wider leading-relaxed subpixel-antialiased"
